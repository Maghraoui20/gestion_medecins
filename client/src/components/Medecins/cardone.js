...
const CardOne = ({Medecin,Tablefav,Tableids,Tablevalider,Tableannuler}) => {
  ...
  console.log(Tableannuler,"ll");
  console.log(Tableannuler.indexOf(Medecin._id),'ojj');
  console.log( Tableids ,"icc");
  return (
...
: user?.Role==="client"   && favoris1 && Tablefav && (Tablefav.indexOf(Medecin._id) > -1 ) ?
 ...
 : user?.Role ==="client"   && !favoris1 && Tablefav && (Tablefav.indexOf(Medecin._id) > -1 ) ? 
 <IconButton  className={classes.iconbtn} onClick={handleannulerfavoris1} >
 <FavoriteIcon  className={classes.favoris}/>
 </IconButton> 
   :
  null}
