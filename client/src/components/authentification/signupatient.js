...
import Img from '../Pictures/malade.gif';
...
const Signup = () => {
  ...
  const clear = () => {
    setsignData({firstname: '', lastname: '', gouvernorate: '', city:'', idgouvernorate:'', idcity:'',cin: '', phone: '', email: '', password: '', confirmerMotdepasse: '' });
  }
  useEffect(() => {
